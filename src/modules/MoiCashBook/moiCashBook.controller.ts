...
export class MoiCashBookController extends BaseController {
    ...
    public create = async (req: Request, res: Response) => {
        ...
        return this.sendCreatedResponse(res, result, 'MoiCashBook created successfully');
    };
    ...
    public getOne = async (req: Request, res: Response) => {
        ...
        if (!result) {
            return this.sendResponse(res, 'MoiCashBook not found', HTTPStatusCode.NOT_FOUND);
        }

        return this.sendResponse(res, 'MoiCashBook retrieved successfully', HTTPStatusCode.OK, result);
    };
    ...
    public update = async (req: Request, res: Response) => {
        ...
        return this.sendResponse(res, 'MoiCashBook updated successfully', HTTPStatusCode.OK, result);
    };
    ...
    public delete = async (req: Request, res: Response) => {
        ...
        return this.sendResponse(res, 'MoiCashBook deleted successfully', HTTPStatusCode.OK);
    };
}
